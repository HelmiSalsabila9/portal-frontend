      ...
      <section class="content">
        <div class="card card-outline card-info">
          <div class="card-header">
            <h3 class="card-title"><i class="nav-icon fa fa-upload mr-1"></i> EDIT POST ARTIKEL</h3>
          ...
          <div class="card-body">
            <form @submit.prevent="updatePost">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="post.title" placeholder="Masukkan Judul Post Artikel" class="form-control">
...
<script>
    export default {
      ...
      head() {
        return {
          title: 'Edit Post - portal.helmisalsabila.com',
        }
      },

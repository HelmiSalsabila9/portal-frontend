    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title"><i class="nav-icon fas fa-tags mr-1"></i> LIST TAG</h3>
        ...
        <div class="card-body">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <nuxt-link :to="{name: 'admin-tag-create'}" class="btn btn-info btn-sm" style="padding-top: 8px;"><i
                    class="fa fa-plus-circle mr-1"></i> TAMBAH TAG</nuxt-link>
              </div>
              <input type="text" class="form-control" v-model="search" @keypress.enter="searchData" placeholder="cari berdasarkan nama tag brow..">
          ...
          <b-table striped bordered hover :items="tags" :fields="fields" show-empty> 
              ...
              <b-button :to="{name: 'admin-tag-edit-id', params: {id: row.item.id}}" variant="info" size="sm">EDIT</b-button>
